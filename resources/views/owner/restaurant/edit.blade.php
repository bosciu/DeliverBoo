            ...
            <div class="row">
                ...
                <section class="col-6">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Inserisci il nome del ristorante" value="{{ old('name', $restaurant->name) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Inserisci la mail del ristorante" value="{{ old('email', $restaurant->email) }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" placeholder="Inserisci il numero di telefono del ristorante" value="{{ old('phone', $restaurant->phone) }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" placeholder="Inserisci l'indirizzo del ristorante" value="{{ old('address', $restaurant->address->address) }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city" placeholder="Inserisci la città del ristorante" value="{{ old('city', $restaurant->address->city) }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control @error('zip_code') is-invalid @enderror" id="zip_code" name="zip_code" placeholder="Inserisci il CAP del ristorante" value="{{ old('zip_code', $restaurant->address->zip_code) }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control @error('province') is-invalid @enderror" id="province" name="province" placeholder="Inserisci la provincia del ristorante" value="{{ old('province', $restaurant->address->province) }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('country') is-invalid @enderror" id="country" name="country" placeholder="Inserisci lo Stato del ristorante" value="{{ old('country', $restaurant->address->country) }}">
                        <div class="invalid-feedback">
                ...
                <section class="col-6">
                    ...
                    <div class="badge-container" id="badge-container">
                        @foreach ($restaurant->restaurantTypes as $restaurantType)
                            <span key="{{ $restaurantType }}" onclick="deleteBadge(this)">
                                <span class="badge badge-pill badge-primary mt-2 mr-2">{{ $restaurantType->name }}</span>
                    ...
                    <div class="form-check mb-3 mt-4">
                        <input class="form-check-input @error('take_away') is-invalid @enderror" type="checkbox" id="take_away" {{ old('take_away', $restaurant->take_away) ? 'checked' : '' }} name="take_away">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="img_container mt-3">
                            <img src="{{ asset('storage/' . $img_path) }}" alt="img" id="edit-image">
                        </div>
                    </div>
            
                    <div class="form-group">
                        <label for="delivery_price">Spese di spedizione</label>
                        <input type="number" max="100" step="0.01" class="form-control @error('delivery_price') is-invalid @enderror" id="delivery_price" name="delivery_price" placeholder="Inserisci il prezzo del delivery" value="{{ old('delivery_price', $restaurant->delivery_price) }}">
                        <div class="invalid-feedback">
